    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "company_text_color",
                    models.CharField(default="#ffffff", max_length=255),
                ),
                (
                ...
                (
                    "company_copyright",
                    models.CharField(default="Beyonderissolutions", max_length=255),
                ),
                (
                    "company_button_color",
                    models.CharField(default="#ffffff", max_length=255),
                ),
                (
                    "company_starting_year",
                    models.CharField(default="2021", max_length=255),
                ),
            ],
            options={
                "abstract": False,
